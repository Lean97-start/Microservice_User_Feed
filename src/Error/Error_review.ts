export default {
    ...
    NOT_EXIST_THE_REVIEW: {errorCode: 404 ,error_message: "The review does not exist" },
    NOT_EXIST_THE_STATE_REVIEW: {errorCode: 404 ,error_message: "The state review does not exist" },
    THERE_IS_NOT_ID_REVIEW: {errorCode: 404 ,error_message: "The _id_review not exist, it is required" },
    THERE_IS_NOT_ARTICLE_BOUGHT_USER: {errorCode: 404 ,error_message: "The article_bought_user not exist, it is required" },
